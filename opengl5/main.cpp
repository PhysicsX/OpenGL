...
int main()
{
   ...
   /// rect(colorTexture);
    ...
    triangleSeris<0>(0.3,1,0,0,0.1);

    triangleSeris<1>(-0.1,0,1,0,0.9);

    triangleSeris<2>(0.0,1,0,0,0.3);
    triangleSeris<3>(0.1,0,0.4,0,0.7);
    triangleSeris<4>(0.2,1,0,0.5,0.2);
    triangleSeris<5>(0.3,0,0.2,0,0.1);
